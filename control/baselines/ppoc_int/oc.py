...
def train(args, env_id, outer_dir):
...
def main():
    ...
    parser.add_argument('--nepisodes', help="Number of episodes per run", type=int, default=300)
    ...
    dir_name = "Runs" + str(args.nruns) + "_Epsds" + str(args.nepisodes) + "_Eps" + str(args.epsilon) + "_NOpt" + str(
        args.noptions) + "_LRT" + str(args.lr_term) + \
