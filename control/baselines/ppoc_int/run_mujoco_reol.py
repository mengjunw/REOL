...
def train(env_id, num_timesteps, seed, num_options,app, saves ,wsaves, epoch,dc,plots,w_intfc,switch,mainlr,intlr,piolr,fewshot,k,u):
    from baselines.ppoc_int import mlp_policy, mlp_policy_bkol, pposgd_simple_reol
    ...
    pposgd_simple_reol.learn(env, policy_fn,
            ...
            w_intfc=w_intfc,switch=switch,intlr=intlr,piolr=piolr,fewshot=fewshot,k=k,u=u
        )
    env.close()
...
def main():
    ...
    parser.add_argument('--u', type=float, default=0.01, help='threshold for re function')
    ...
    train(args.env, num_timesteps=args.timesteps, seed=args.seed, num_options=args.opt, app=args.app,
     ...
     w_intfc=args.w_intfc,switch=args.switch,mainlr=args.mainlr,intlr=args.intlr,piolr=args.piolr,fewshot=args.fewshot,k=args.k,u=args.u)
