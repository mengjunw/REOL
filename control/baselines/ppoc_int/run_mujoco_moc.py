...
def train(env_id, num_timesteps, seed, num_options, app, saves, wsaves, epoch, w_intfc, switch, mainlr, intlr, piolr, multi, eta):
    import mlp_policy_moc, pposgd_simple_moc
    ...
    def policy_fn(name, ob_space, ac_space):
        return mlp_policy_moc.MlpPolicy(name=name, ob_space=ob_space, ac_space=ac_space,
    ...
    pposgd_simple_moc.learn(env, policy_fn,
